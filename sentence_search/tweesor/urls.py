...
urlpatterns = [
    ...
    path('follower_order/<str:order>', views.index.Index.as_view(), name='follower_order'),
    path('learn_iine_order/<str:order>/<int:label_id>', views.learn_tweet.LearnedTweet.as_view(), name='learn_iine_order'),
    path('learn_follower_order/<str:order>/<int:label_id>', views.learn_tweet.LearnedTweet.as_view(), name='learn_follower_order'),
